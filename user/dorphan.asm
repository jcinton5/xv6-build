...
main(int argc, char **argv)
{
  ...
  10:	90450513          	addi	a0,a0,-1788 # 910 <malloc+0x106>
  14:	372000ef          	jal	386 <mkdir>
  18:	c919                	beqz	a0,2e <main+0x2e>
    printf("%s: mkdir dd failed\n", s);
  1a:	85a6                	mv	a1,s1
  1c:	00001517          	auipc	a0,0x1
  20:	8fc50513          	addi	a0,a0,-1796 # 918 <malloc+0x10e>
  24:	732000ef          	jal	756 <printf>
    exit(1);
  28:	4505                	li	a0,1
  ...
  32:	8e250513          	addi	a0,a0,-1822 # 910 <malloc+0x106>
  36:	358000ef          	jal	38e <chdir>
  3a:	c919                	beqz	a0,50 <main+0x50>
    printf("%s: chdir dd failed\n", s);
  3c:	85a6                	mv	a1,s1
  3e:	00001517          	auipc	a0,0x1
  42:	8f250513          	addi	a0,a0,-1806 # 930 <malloc+0x126>
  46:	710000ef          	jal	756 <printf>
    exit(1);
  4a:	4505                	li	a0,1
  ...
  54:	8f850513          	addi	a0,a0,-1800 # 948 <malloc+0x13e>
  ...
  64:	90850513          	addi	a0,a0,-1784 # 968 <malloc+0x15e>
  ...
  7c:	8d850513          	addi	a0,a0,-1832 # 950 <malloc+0x146>
  80:	6d6000ef          	jal	756 <printf>
    exit(1);
  84:	4505                	li	a0,1
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 40a:	58a50513          	addi	a0,a0,1418 # 990 <digits>
 40e:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6a0:	2f4b8b93          	addi	s7,s7,756 # 990 <digits>
...
malloc(uint nbytes)
{
 ...
 86e:	99e78793          	addi	a5,a5,-1634 # 1208 <base>
